  ...
  return (
    <div className="d-flex flex-column vh-100">
      ...
      <Container fluid className="flex-grow-1 overflow-hidden">
        ...
        <Row className="h-100 g-0">
          {/* Sidebar - Channel List (Hidden on mobile when channel selected) */}
          <Col 
            md={3} 
            lg={3} 
            className={`border-end bg-white ${selectedChannel ? 'd-none d-md-block' : ''}`}
          ...
          {/* Main - Chat Window (Full screen on mobile when channel selected) */}
          <Col 
            md={9} 
            lg={9}
            className={selectedChannel ? '' : 'd-none d-md-block'}
            style={{ height: 'calc(100vh - 56px)' }}
          >
